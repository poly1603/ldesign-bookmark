 ...
 * 默认书签状态
 */
export declare const DEFAULT_BOOKMARK_STATE: BookmarkState;
/**
 * 书签选中事件参数
 */
 ...
 * 书签事件处理器类型
 */
export type BookmarkEventHandler<K extends keyof BookmarkEventMap> = (params: BookmarkEventMap[K]) => void;
